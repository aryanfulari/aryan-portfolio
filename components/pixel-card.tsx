...
const VARIANTS: Record<string, { activeColor: string | null; gap: number; speed: number; colors: string }> = {
  default: {
    activeColor: null,
    gap: 5,
    speed: 35,
...
export default function PixelCard({ variant = "default", gap, speed, colors, className = "", style, children }: PixelCardProps) {
